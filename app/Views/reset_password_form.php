      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          <div id="darkform" class=" card-body p-4 p-sm-5">
            <h4 class="title card-title text-center mb-5 fw-light fs-2"><strong> Redefinier Senha </strong></h4>

            
            <form action="<?= base_url('index.php/reset-password') ?>" method="POST">
            ...
            <div class="form-floating mb-3">
              <input type="text" name="doc" class="form-control" id="floatingInput" placeholder="Documento" required>
              <label for="floatingInput">Informe CPF utilizado no cadastro (somente números)</label>
            </div>
            ...
            <div class="d-grid">
              <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Redefinir senha</button>
            </div>
